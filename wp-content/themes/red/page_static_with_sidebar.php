  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <?php if( get_field('red-link1') ): ?>
       <a herf="<?php the_field('red-link1'); ?>" class="project-content"><?php the_field('red-link1-description'); ?></a>
      <?php endif; ?>
      ...
      <?php if( get_field('red-link2') ): ?>
       <a herf="<?php the_field('red-link2'); ?>" class="project-content"><?php the_field('red-link2-description'); ?></a>
      <?php endif; ?>
      ...
      <?php if( get_field('red-link3') ): ?>
       <a herf="<?php the_field('red-link3'); ?>" class="project-content"><?php the_field('red-link3-description'); ?></a>
      <?php endif; ?>


      <!--CONTACT LABEL-->
      <?php if( get_field('red-contact-label') ): ?>
       <p class="project-content"><?php the_field('red-contact-label'); ?></p>
      <?php endif; ?>

       <?php if( get_field('red-contact-field-1') ): ?>
       <p class="project-content"><?php the_field('red-contact-field-1'); ?></p>
      <?php endif; ?>

      <?php if( get_field('red-contact-field-2') ): ?>
       <p class="project-content"><?php the_field('red-contact-field-2'); ?></p>
      <?php endif; ?>

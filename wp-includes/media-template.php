...
function wp_print_media_templates() {
	...
	<script type="text/html" id="tmpl-gallery-settings">
		<h2 class="gallery-settings-updated-title">Gallery Settings</h2>
		<p class="gallery-settings-updated-desc instructions">Gallery settings have been pre-confiurged to ensure consistency. <br /><br />This particular gallery displays images in a 3-column masonry format.</p>
		<?php /*
